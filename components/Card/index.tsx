              ...
              <CardActionArea sx={{ display: "flex", flexDirection: "column", alignContent: "space-between", justifyContent: "space-between" }}>
                <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <div className="p-3">
                    ...
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Đón Tết Nguyên Đán bên gia đình và bạn bè, bạn đã lên kế hoạch du lịch xuyên Tết tại Hà Nội chưa? Go2Joy đã chọn lọc 10 địa điểm khách sạn mở xuyên Tết…</p>
